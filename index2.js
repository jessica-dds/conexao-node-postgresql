...
app.get('/', async (req, res) => {
    ...
    try {
        ...
        const resultado = await pool.query(query, [porPagina, offset]); // muda conforme os params 
        const result = {
            pagina,
            porPagina,
        ...
        return res.json(result); //rowCount = quantidade de registros - rows = tudo que houver no banco de dados
    } catch (error) {
